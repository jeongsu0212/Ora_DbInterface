...
public class TestMemberService {
	...
	public void memberDelete() throws Exception {
		...
		System.out.println("디버그 tpo1구하기"+memberList.get(0).getUserid());
	...
	public void oracle_connect() throws SQLException {
		...
		//new 키워드 객체를 만들게 허용하면 , 객체를 계속 생성이 가능(시스템부담)
		//한번 커넥션이 되면 ,커넥션을 2번이상 호출하지 않게 됨.
		System.out.println("현재 접속된 DB커넥션은 "+ connect);
	}
	
	@Test
	public void junit_test() {
		System.out.println("JUnit실행확인 메소드!");
	}
}
